...
is $request->http_method, 'post', 'Class has correct http method';

is $request->destination, 'https://base.example.org/api/domains', 'Correct destination';
...
is $request->printable->{'smtp_password'}, 'exAmple', 'Request has correct password after being printified.';
